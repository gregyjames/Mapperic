...
namespace DTOGenerator
{
    ...
    public class DtoSourceGenerator : IIncrementalGenerator
    {
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            ...
            var classDtoResults = compilationAndClasses
                .SelectMany((tuple, _) =>
                {
                    ...
                    var generateDtoAttr  = compilation.GetTypeByMetadataName("DTOGenerator.Attributes.GenerateDtoAttribute");
                    var dtoPropertyAttr  = compilation.GetTypeByMetadataName("DTOGenerator.Attributes.DtoPropertyAttribute");
                    var addDtoPropertyAttr = compilation.GetTypeByMetadataName("DTOGenerator.Attributes.AddDtoPropertyAttribute");
        ...
        private static string GenerateMappingProfile(IReadOnlyList<ClassDtoResult> allClasses)
        {
            ...
            sb.AppendLine();
            sb.AppendLine("namespace DTOGenerator.Profiles");
            sb.AppendLine("{");
